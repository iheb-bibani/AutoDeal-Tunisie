...
COLONNES_FINALES = [
    ...
    "Puissance_Fiscale", "Etat_Vehicule", "Description", "Options", "Nb_Options",
    "Annonce-Deposee", "Annonce-Detectee", "Statut", "Lien",
]
        ...
        for i, car in enumerate(data_cars):
            if car["Lien"]:
                try:
                    ...
                    # Description et équipements : best-effort, sans dépendre
                    # d'un seul nom de classe Tailwind susceptible de changer.
                    # On préfère les blocs textuels longs et les listes d'options
                    # de la fiche détail. Si rien n'est trouvé, on garde None.
                    for sel in [
                        "[data-testid='description']",
                        "section:has-text('Description') p",
                    ...
                    options = []
                    for sel in [
                        "section:has-text('Équipements') li",
                        "section:has-text('Equipements') li",
                        "div:has-text('Équipements') li",
                    ]:
                        try:
                    ...
                    car["Options"] = " | ".join(options) if options else None
                    car["Nb_Options"] = len(options) if options else None
